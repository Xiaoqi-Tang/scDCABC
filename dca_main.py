...
def parse_args():
    ...
    parser.add_argument('input', type=str, nargs='?', default="D:/琦/binna改进/data/E-MTAB-3321/E-MTAB-3321.csv",
    ...
    parser.add_argument('outputdir', type=str,  nargs='?', default="C:/Users/W10/Desktop/latent", help='The path of the output directory')
    """
...
def main():
    args = parse_args()
    #args.input = "D:/琦/binna改进/data/E-MTAB-3321/E-MTAB-3321.csv"
    #print(args.input)
    #args.outputdir = "C:/Users/W10/Desktop/DD/E-MTAB-3321/latent"
