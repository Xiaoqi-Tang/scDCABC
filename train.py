...
# 打印数据集信息
    ...
    print(f"Number of training samples: {adata[adata.obs.dca_split == 'train'].shape[0]}")
    ...
    print(f"Inputs shape: {inputs['count'].shape}")
...
def train_with_args(args):
    ...
    net.save()
    net.build()
    print(f"adata.obs['dca_split']: {adata.obs['dca_split'].value_counts()}")
